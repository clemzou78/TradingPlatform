...
public class MesEncheres extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Contrat> lc=sc.getEnchereParticipe(initiateur.getIdInvestisseur(),0);
		...
		this.getServletContext().getRequestDispatcher( "/invest/mesEncheres.jsp" ).forward( request, response );
