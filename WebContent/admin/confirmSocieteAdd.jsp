               ...
               <!-- Page Heading -->
                ...
                <div class="row">
                    <div class="col-lg-6">
						  ...
						  <div class="well">
						  <p>La société <%=((Societe)s.getAttribute("societe")).getNom() %> a été validée.</p>
						  <p>Les identifiants générés sont : </p>
						  <ul>
						  ...
						  <a class="btn btn-primary" href="indexAdmin.jsp">Retour à la liste des sociétés</a>                 
                    </div>
